...
function unlockAsset(downloadUrl) {
    // 1. Download link ko save kar lo taaki ad khatam hone ke baad mil sake
    pendingDownloadUrl = downloadUrl; 

    // 2. Check karo agar Android App ne koi "AdBridge" diya hai
    if (typeof AndroidBridge !== 'undefined' && typeof AndroidBridge.showRewardedAd === 'function') {
        // Agar Android me app run ho rahi hai, toh native Android ad trigger karo
        AndroidBridge.showRewardedAd();
    } 
    // Fallback: Agar browser me test kar rahe ho toh fake 2-second ad chalega
    else {
        alert("📺 [Test Mode] Loading Video Ad...");
        setTimeout(() => {
            // Test ad khatam, ab direct reward function call kar do
